    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center mb-3">
                <h2>Pendaftaran Seminar Internasional</h2>
                <hr>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-10 mx-auto text-sm form-sm">
                @if (session('success') || session('error'))
                    ...
                    @endif
                    <form action="{{ route('pendaftaran.seminar.store') }}" method="post">
                        @csrf
                    <div class="form-group">
                        <label for="nama_lengkap"><b>Nama Lengkap:</b></label>
                        <input type="text" class="form-control form-control-alternative" id="nama_lengkap" name="nama_lengkap" required>
                        <small><em>Masukkan nama lengkap dengan gelar Anda jika ada.</em></small>
                    </div>
                    <div class="form-group">
                        <label for="no_identitas"><b>NIK:</b></label>
                        <input type="text" class="form-control form-control-alternative" id="no_identitas" name="no_identitas" required>
                    </div>
                    <div class="form-group">
                        <label for="status"><b>Keikutsertaan:</b></label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-alternative" id="nama_instansi" name="nama_instansi" required>
                    </div>
                    <div class="form-group">
                        <label for="alamat"><b>Alamat:</b></label>
                        <input type="text" class="form-control form-control-alternative" id="alamat" name="alamat" required>
                    </div>
                    <div class="form-group">
                        <label for="no_hp"><b>No. HP:</b></label> 
                        <input type="tel" class="form-control form-control-alternative" id="no_hp" name="no_hp" required>
                    </div>
