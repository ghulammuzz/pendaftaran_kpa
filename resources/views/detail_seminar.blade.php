        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center mb-3">
                    <h2>Data Peserta Konferensi Internasional</h2>
                    <hr>
                </div>
            </div>
            <table class="table">
                ...
                <tbody class="text-center">
                    @foreach ($pesertas as $index => $peserta)
                        <tr>
                            ...
                            <td style="line-height: 1;">{{ $peserta->status }}</td>
                            <td>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" style="text-align: left;">
                                                ...
                                                <p style="font-size: 14px;"><b>Nama:</b> {{ $peserta->nama_lengkap }}</p>
                                                <p style="font-size: 14px; white-space: pre-line;"><b>Alamat:</b> {{ $peserta->alamat }}</p>
                                                <p style="font-size: 14px;"><b>Asal Instansi:</b> {{ $peserta->nama_instansi }}</p>
                                                <p style="font-size: 14px;"><b>Nomor Handphone:</b> {{ $peserta->no_hp }}</p>
                                                <p style="font-size: 14px;"><b>Keikutsertaan:</b> {{ $peserta->status }}</p>
                                                <p style="font-size: 14px; white-space: pre-line;">
                                                    <b>Judul Makalah:</b> {{ $peserta->judul }}
                                                </p>
                                                <p style="font-size: 14px; white-space: pre-line;">
                                                    <b>Abstrak:</b> {{ $peserta->abstrak }}
                                                </p>
                                                <p style="font-size: 14px;"><b>Bukti Pembayaran:</b> {{ $peserta->bukti_pembayaran }}</p>
