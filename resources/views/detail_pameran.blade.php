                ...
                <tbody class="text-center">
                    @foreach ($pesertas as $index => $peserta)
                        <tr>
                            ...
                            <td style="line-height: 1;">{{ $peserta->jenis_usaha }}</td>
                            <td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" style="text-align: left;">
                                                ...
                                                <p style="font-size: 14px; white-space: pre-line;"><b>Alamat:</b>
                                                    {{ $peserta->alamat }}</p>
                                                <p style="font-size: 14px;"><b>Asal Instansi:</b>
                                                    {{ $peserta->nama_instansi }}</p>
                                                <p style="font-size: 14px;"><b>Nomor Handphone:</b> {{ $peserta->no_hp }}
                                                </p>
                                                <p style="font-size: 14px;"><b>Jenis Usaha:</b> {{ $peserta->jenis_usaha }}
                                                </p>
                                                <p style="font-size: 14px;"><b>Ukuran Sewa Tenda:</b>
                                                    {{ $peserta->ukuran_tenda }}</p>
                                                <p style="font-size: 14px;"><b>Bukti Pembayaran:</b>
                                                    {{ $peserta->bukti_pembayaran }}</p>
